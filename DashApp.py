...
# Which site has the largest successful launches?                                                                   ANSWER: KSC LC-39A
# Which site has the highest launch success rate?                                                                   ANSWER: KSC LC-39A (success rate 76.9%)
# Which payload range(s) has the highest launch success rate?                                                       ANSWER: 2000-4000
# Which payload range(s) has the lowest launch success rate?                                                        ANSWER: 6000-8000
# Which F9 Booster version (v1.0, v1.1, FT, B4, B5, etc.) has the highest launch success rate?                      ANSWER: B5 with only one successful sample. On the other hand, with many entries FT has 15 successes over 8 failures